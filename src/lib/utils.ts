...
export const EXPENSE_CATEGORIES = [
  ...
  { value: "tax_payment", label: "Tax/GST Payment", icon: "Receipt" },
  { value: "credit_card_bill", label: "Credit Card Bill", icon: "CreditCard" },
  { value: "recharge", label: "Recharge/Mobile", icon: "Smartphone" },
  { value: "household", label: "Household Help", icon: "Users" },
